...
*/
  ...
  function Ba(a, b) {
    for (var c = xa(a.h()), d = 0; d < c.length; d++) {
      var e = c[d],
        f = e.a;
      if (q(b, f)) {
        a.a && delete a.a[e.a];
        ...
        if (e.f) {
          e = v(b, f);
          for (var h = 0; h < e.length; h++) Aa(a, f, g ? e[h].clone() : e[h]);
        } else
          (e = Ca(b, f)),
            g ? ((g = Ca(a, f)) ? Ba(g, e) : u(a, f, e.clone())) : u(a, f, e);
      }
    }
  }
  p.prototype.clone = function () {
    var a = new this.constructor();
    a != this && ((a.b = {}), a.a && (a.a = {}), Ba(a, this));
    return a;
  };
  function q(a, b) {
    return null != a.b[b];
  ...
  function x(a, b) {
    return a.f[b].f ? (q(a, b) ? a.b[b].length : 0) : q(a, b) ? 1 : 0;
  }
  function u(a, b, c) {
    a.b[b] = c;
    a.a && (a.a[b] = c);
  ...
  y.prototype.a = function (a, b) {
    if (11 == a.b || 10 == a.b)
      return b instanceof p ? b : this.f(a.l.prototype.h(), b);
    if (14 == a.b)
      return "string" === typeof b && Fa.test(b) && ((a = Number(b)), 0 < a)
        ? a
        : b;
    if (!a.i) return b;
    a = a.l;
    if (a === String) {
      ...
      a === Number &&
      "string" === typeof b &&
      ("Infinity" === b || "-Infinity" === b || "NaN" === b || Fa.test(b))
    )
      return Number(b);
    return b;
  };
  ...
  z.prototype.g = function (a) {
    for (var b = xa(a.h()), c = {}, d = 0; d < b.length; d++) {
      var e = b[d],
        f = e.a;
      switch (this.j) {
        case 1:
          ...
          break;
        case 2:
          f = na(e.j.replace(/_/g, "-"));
      }
      if (a.has(e))
        if (e.f) {
          var g = [];
          c[f] = g;
          for (f = 0; f < x(a, e.a); f++) g.push(this.b(e, a.get(e, f)));
  ...
  z.prototype.b = function (a, b) {
    return this.m && 8 == a.b && "boolean" === typeof b
      ? b
        ? 1
        : 0
      : z.ga.b.call(this, a, b);
  };
  z.prototype.a = function (a, b) {
    return 8 == a.b && "number" === typeof b ? !!b : z.ga.a.call(this, a, b);
  };
    ...
    for (d in b) {
      ...
      if (f) var g = c.a[parseInt(d, 10)] || null;
        ...
        2 == this.j &&
          ...
          (g = ya(c, d));
      if (g)
        if (g.f) for (f = 0; f < e.length; f++) a.add(g, this.a(g, e[f]));
        else a.set(g, this.a(g, e));
      else
        f
          ? ((g = a), (f = Number(d)), (g.b[f] = e), g.a && delete g.a[f])
          : this.l || ia("Failed to find field: " + d);
    }
  };
  function A(a, b) {
...
*/
  ...
  C.prototype.h = function () {
    ...
    a ||
      (Ga = a =
        Ea(C, {
          0: { name: "NumberFormat", da: "i18n.phonenumbers.NumberFormat" },
      ...
      (Ha = a =
        Ea(D, {
          0: {
            ...
            da: "i18n.phonenumbers.PhoneNumberDesc",
          },
  ...
  E.prototype.h = function () {
    ...
    a ||
      (Ia = a =
        Ea(E, {
          0: { name: "PhoneMetadata", da: "i18n.phonenumbers.PhoneMetadata" },
          ...
          19: { name: "number_format", v: !0, c: 11, type: C },
          20: { name: "intl_number_format", v: !0, c: 11, type: C },
          22: {
  ...
  F.prototype.g = function (a) {
    for (var b = xa(a.h()), c = [], d = 0; d < b.length; d++) {
      ...
      if (a.has(e)) {
        ...
        if (e.f) {
          c[f] = [];
          for (var g = 0; g < x(a, e.a); g++) c[f][g] = this.b(e, a.get(e, g));
        } else c[f] = this.b(e, a.get(e));
      }
    }
    za(a, function (h, m) {
  ...
  F.prototype.b = function (a, b) {
    return 8 == a.b ? (b ? 1 : 0) : y.prototype.b.apply(this, arguments);
  };
  F.prototype.a = function (a, b) {
    return 8 == a.b ? !!b : y.prototype.a.apply(this, arguments);
  };
  F.prototype.f = function (a, b) {
    return F.ga.f.call(this, a, b);
  };
  function G() {
    p.call(this);
  }
  k(G, p);
  var Ka = null,
    La = { pa: 0, oa: 1, na: 5, ma: 10, la: 20 };
  G.prototype.h = function () {
    var a = Ka;
    a ||
      (Ka = a =
        Ea(G, {
          0: { name: "PhoneNumber", da: "i18n.phonenumbers.PhoneNumber" },
          ...
          6: { name: "country_code_source", c: 14, defaultValue: 0, type: La },
          7: { name: "preferred_domestic_carrier_code", c: 9, type: String },
        }));
    return a;
  };
  G.ctor = G;
  G.ctor.h = G.prototype.h; /*
  ...
  var H = {
    ...
    Ma = {
      ...
      GF: [
        ...
        [, , "594(?:[02-49]\\d|[16][0-3]|5[6-9]|80)\\d{4}", , , , "594101234"],
      ...
      MQ: [
        ...
        [
          ,
          ,
          "596(?:[03-7]\\d|10|2[7-9]|8[0-39]|9[4-9])\\d{4}",
          ,
          ,
          ,
          "596301234",
      ...
      RE: [
        ,
        [, , "(?:26|[689]\\d)\\d{7}", , , , , , , [9]],
        [, , "26(?:2\\d\\d|3(?:0\\d|1[0-4]))\\d{4}", , , , "262161234"],
        [
          ,
          ,
      ...
      YT: [
        ...
        [, , "269(?:0[0-467]|5[0-4]|6\\d|[78]0)\\d{4}", , , , "269601234"],
        [
          ,
          ,
...
*/
  ...
  function hb(a) {
    return 2 > a.length ? !1 : L(ab, a);
  }
  function ib(a) {
    return L(Wa, a) ? M(a, Pa) : M(a, I);
  }
  function jb(a) {
    var b = ib(a.toString());
    B(a);
  ...
  function kb(a) {
    return null != a && (1 != x(a, 9) || -1 != v(a, 9)[0]);
  }
  function M(a, b) {
    for (var c = new A(), d, e = a.length, f = 0; f < e; ++f)
      (d = a.charAt(f)), (d = b[d.toUpperCase()]), null != d && c.a(d);
    return c.toString();
  }
  function lb(a) {
    return 0 == a.length || fb.test(a);
  }
  function mb(a) {
    return null != a && isNaN(a) && a.toUpperCase() in Ma;
  }
  function N(a, b, c) {
    if (0 == r(b, 2) && q(b, 5)) {
      var d = w(b, 5);
  ...
  function qb(a, b) {
    return pb(a, b, 0 < w(b, 7).length ? w(b, 7) : "");
  }
  function rb(a) {
    var b = U,
      c = w(a, 1);
    if (!(c in H)) return q(a, 5) ? w(a, 5) : "";
    var d = "";
    a = a.clone();
    Da(a, 3);
    var e = S(c),
      ...
      g = -1 != f;
    if ("US" == e)
      if (((d = 0 == f || 1 == f || 2 == f), "BR" == e && d))
        d = 0 < w(a, 7).length ? qb(b, a) : "";
      else if (1 == c) {
        c = T(b, "US");
        if ((d = ub(b, a))) (d = P(a)), (d = 2 != V(b, d, c, -1));
        d = d ? N(b, a, 1) : N(b, a, 2);
      } else
        d =
          ("001" == e || (("MX" == e || "CL" == e || "UZ" == e) && d)) &&
          ub(b, a)
            ? N(b, a, 1)
            : N(b, a, 2);
    else if (g && ub(b, a)) return N(b, a, 1);
    return d;
  }
  function vb(a, b, c) {
    if (!mb(c)) return N(a, b, 1);
    var d = w(b, 1),
      e = P(b);
    if (!(d in H)) return e;
    if (1 == d) {
      if (null != c && H[1].includes(c.toUpperCase()))
        return d + " " + N(a, b, 2);
    } else if (d == wb(a, c)) return N(a, b, 2);
    var f = T(a, c),
      g = w(f, 11);
    c = "";
    q(f, 17) ? (c = w(f, 17)) : L(Qa, g) && (c = g);
    a = R(a, d, S(d));
    e = ob(e, a, 1);
    b = nb(b, a, 1);
    return 0 < c.length ? c + " " + d + " " + e + b : Q(d, 1, e, b);
  }
  function xb(a, b) {
    var c = U,
      d;
    ...
    switch (r(a, 6)) {
      ...
      default:
        ...
        if (null == b) var f = null;
          ...
          (b = w(b, 12)), (f = 0 == b.length ? null : (b = b.replace("~", "")));
        b = N(c, a, 2);
        if (null == f || 0 == f.length) c = b;
        else {
          a: {
            e = w(a, 5);
            e = M(e, I);
            if (0 == e.lastIndexOf(f, 0))
              try {
                var g = zb(c, Ab(c, e.substring(f.length), d, !1));
                break a;
              } catch (h) {}
            g = !1;
          }
  ...
  function ob(a, b, c, d) {
    b = 0 == v(b, 20).length || 2 == c ? v(b, 19) : v(b, 20);
    b = yb(b, a);
    return null == b ? a : Bb(a, b, c, d);
  }
  function yb(a, b) {
    for (var c, d = a.length, e = 0; e < d; ++e) {
      c = a[e];
      var f = x(c, 3);
      if (0 == f || 0 == b.search(r(c, 3, f - 1)))
        if (((f = new RegExp(r(c, 1))), L(f, b))) return c;
    }
    return null;
  }
  function Bb(a, b, c, d) {
    var e = w(b, 2),
      f = new RegExp(r(b, 1)),
      g = w(b, 5);
    2 == c && null != d && 0 < d.length && 0 < g.length
      ? ((b = g.replace(eb, d)), (e = e.replace(bb, b)), (a = a.replace(f, e)))
      : ((b = w(b, 4)),
        (a =
          2 == c && null != b && 0 < b.length
            ? a.replace(f, e.replace(bb, b))
            : a.replace(f, e)));
    3 == c &&
      ((a = a.replace(
        /^[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]+/,
  ...
  function W(a, b) {
    var c = a.length;
    return 0 < x(b, 9) && -1 == v(b, 9).indexOf(c) ? !1 : L(w(b, 2), a);
  }
  function zb(a, b) {
    var c = Db(a, b);
    return Fb(a, b, c);
  ...
  function Fb(a, b, c) {
    var d = w(b, 1),
      e = R(a, d, c);
    if (null == e || ("001" != c && d != wb(a, c))) return !1;
    a = P(b);
    return -1 != Eb(a, e);
  }
  function Db(a, b) {
  ...
  function V(a, b, c, d) {
    var e = Cb(c, d),
      f = 0 == x(e, 9) ? v(r(c, 1), 9) : v(e, 9);
    e = v(e, 10);
    if (2 == d)
      if (kb(Cb(c, 0)))
        (a = Cb(c, 1)),
          kb(a) &&
            ((f = f.concat(0 == x(a, 9) ? v(r(c, 1), 9) : v(a, 9))),
            f.sort(),
            0 == e.length
              ? (e = v(a, 10))
              : ((e = e.concat(v(a, 10))), e.sort()));
  ...
  function Hb(a, b) {
    ...
    for (var c, d = a.length, e = 1; 3 >= e && e <= d; ++e)
      if (((c = parseInt(a.substring(0, e), 10)), c in H))
        return b.a(a.substring(e)), c;
    return 0;
  }
  function Ib(a, b, c, d, e, f) {
    ...
    var h = b.toString();
    if (0 == h.length) g = 20;
    else if (J.test(h)) (h = h.replace(J, "")), B(b), b.a(ib(h)), (g = 1);
    else {
      h = new RegExp(g);
      jb(b);
      g = b.toString();
      if (0 == g.search(h)) {
        ...
        var m = g.substring(h).match(Sa);
        m && null != m[1] && 0 < m[1].length && "0" == M(m[1], I)
          ? (g = !1)
          : (B(b), b.a(g.substring(h)), (g = !0));
      } else g = !1;
      g = g ? 5 : 20;
    }
    e && u(f, 6, g);
    ...
    if (
      ...
      (m = b.toString()),
      0 == m.lastIndexOf(h, 0) &&
        ((h = new A(m.substring(h.length))),
        (m = r(c, 1)),
        (m = new RegExp(w(m, 2))),
        Jb(h, c, null),
        (h = h.toString()),
        (!L(m, b.toString()) && L(m, h)) || 3 == V(a, b.toString(), c, -1)))
    )
    ...
    if (0 != e && null != f && 0 != f.length) {
      ...
      if ((e = g.exec(d))) {
        ...
        if (null == b || 0 == b.length || null == e[m] || 0 == e[m].length) {
          if (!h || L(f, d.substring(e[0].length)))
            null != c && 0 < m && null != e[m] && c.a(e[1]),
              a.set(d.substring(e[0].length));
        } else if (((d = d.replace(g, b)), !h || L(f, d)))
          null != c && 0 < m && c.a(e[1]), a.set(d);
      }
    }
  }
  function Ab(a, b, c, d) {
    ...
    null == h
      ...
      : 0 === h.length
      ? (g = !1)
      : ((g = Xa.exec(h)), (h = Ya.exec(h)), (g = null !== g || null !== h));
    if (!g)
      throw Error("The string supplied did not seem to be a phone number");
    null != f
      ? ("+" === f.charAt(0) && e.a(f),
        (f = b.indexOf("tel:")),
        e.a(b.substring(0 <= f ? f + 4 : 0, b.indexOf(";phone-context="))))
      : e.a(gb(null != b ? b : ""));
    f = e.toString();
    g = f.indexOf(";isub=");
    0 < g && (B(e), e.a(f.substring(0, g)));
    if (!hb(e.toString()))
      throw Error("The string supplied did not seem to be a phone number");
    f = e.toString();
    if (!(mb(c) || (null != f && 0 < f.length && J.test(f))))
      throw Error("Invalid country calling code");
    f = new G();
    d && u(f, 5, b);
    a: {
      ...
      if (0 <= g && hb(b.substring(0, g))) {
        h = b.match($a);
        for (var m = h.length, t = 1; t < m; ++t)
          if (null != h[t] && 0 < h[t].length) {
            B(e);
            e.a(b.substring(0, g));
            b = h[t];
            break a;
    ...
    try {
      ...
      if ("Invalid country calling code" == O.message && J.test(m)) {
        if (((m = m.replace(J, "")), (h = Ib(a, m, g, b, d, f)), 0 == h))
          throw O;
      } else throw O;
    }
    0 != h
      ...
      : (jb(e),
        b.a(e.toString()),
        null != c ? ((h = w(g, 10)), u(f, 1, h)) : d && Da(f, 6));
    if (2 > b.b.length)
    ...
    null != g &&
      ...
      2 != a &&
        4 != a &&
        5 != a &&
        ((b = e), d && 0 < c.toString().length && u(f, 7, c.toString())));
    d = b.toString();
    a = d.length;
    if (2 > a)
      throw Error("The string supplied is too short to be a phone number");
  ...
  function Pb(a) {
    for (var b = a.f.length, c = 0; c < b; ++c) {
      ...
      var m = f;
      g = w(g, 2);
      var t = "999999999999999".match(h)[0];
      t.length < m.a.b.length
        ? (m = "")
        : ((m = t.replace(new RegExp(h, "g"), g)),
          (m = m.replace(/9/g, "\u2008")));
      0 < m.length ? (f.m.a(m), (f = !0)) : (f = !1);
      if (f) return (a.$ = e), (a.ca = Ob.test(r(d, 4))), (a.u = 0), !0;
    }
    return (a.l = !1);
  }
  function Qb(a, b) {
  ...
  function Sb(a, b) {
    a.j.a(b);
    var c = b;
    Sa.test(c) || (1 == a.j.b.length && Ra.test(c))
      ? ("+" == b ? ((c = b), a.o.a(b)) : ((c = I[b]), a.o.a(c), a.a.a(c)),
        (b = c))
      : ((a.l = !1), (a.ka = !0));
    if (!a.l) {
      if (!a.ka)
    ...
    switch (a.o.b.length) {
      ...
      case 3:
        if (Tb(a)) a.aa = !0;
        else return (a.i = Wb(a)), Xb(a);
      default:
        if (a.aa) return Ub(a) && (a.aa = !1), a.b.toString() + a.a.toString();
        if (0 < a.f.length) {
          b = Yb(a, b);
          c = Zb(a);
          if (0 < c.length) return c;
          Qb(a, a.a.toString());
          return Pb(a) ? $b(a) : a.l ? ac(a, b) : a.j.toString();
        }
        return Xb(a);
    }
  }
  ...
  function ac(a, b) {
    var c = a.b.b.length;
    return a.ca && 0 < c && " " != a.b.toString().charAt(c - 1)
      ? a.b + " " + b
      : a.b + b;
  }
  function Xb(a) {
    ...
    if (3 <= b.length) {
      for (
        var c =
            a.s && 0 == a.i.length && 0 < x(a.g, 20) ? v(a.g, 20) : v(a.g, 19),
          d = c.length,
          e = 0;
        e < d;
        ++e
        ...
        var f = c[e];
        (0 < a.i.length && lb(w(f, 4)) && !r(f, 6) && !q(f, 5)) ||
          ((0 != a.i.length || a.s || lb(w(f, 4)) || r(f, 6)) &&
            Nb.test(w(f, 2)) &&
            a.f.push(f));
      }
      Qb(a, b);
      b = Zb(a);
      return 0 < b.length ? b : Pb(a) ? $b(a) : a.j.toString();
    }
    return ac(a, b);
  }
  function $b(a) {
    var b = a.a.toString(),
      c = b.length;
    if (0 < c) {
      for (var d = "", e = 0; e < c; e++) d = Yb(a, b.charAt(e));
      return a.l ? ac(a, d) : a.j.toString();
    }
    return a.b.toString();
  }
  function Wb(a) {
    ...
    d
      ? ((c = 1), a.b.a("1").a(" "), (a.s = !0))
      : q(a.g, 15) &&
        ((d = new RegExp("^(?:" + r(a.g, 15) + ")")),
        (d = b.match(d)),
        null != d &&
          null != d[0] &&
          0 < d[0].length &&
          ((a.s = !0), (c = d[0].length), a.b.a(b.substring(0, c))));
    B(a.a);
    a.a.a(b.substring(c));
  ...
  function Ub(a) {
    ...
    a.a.a(b.toString());
    b = S(c);
    "001" == b ? (a.g = T(a.ba, "" + c)) : b != a.ja && (a.g = Lb(a, b));
    a.b.a("" + c).a(" ");
    a.i = "";
    return !0;
  }
...
*/
  ...
  function ic(a, b) {
    ...
    for (var d = 0; d < c.length; d++) {
      var e = gc(a, c[d]);
      if (e && v(r(e, 1), 9).includes(b)) return !0;
    }
    return !1;
  }
  function jc(a, b, c) {
  ...
  function lc(a, b) {
    ...
    return 1 < c.length && null != d ? !0 : jc(a, b, d);
  }
  function gc(a, b) {
    if (!b) return null;
    b = b.toUpperCase();
  ...
  function kc(a, b) {
    return 0 < v(b, 9).length && !v(b, 9).includes(a.length)
      ? !1
      : L(w(b, 2), a.toString());
  }
  var U = Na.ea();
  ...
  function nc() {
    var a = n("phoneNumber").value,
      b = n("defaultCountry").value.toUpperCase(),
      c = n("carrierCode").value,
      d = new A();
    try {
      var e = U;
      if (!mb(b) && 0 < a.length && "+" != a.charAt(0))
        throw Error("Invalid country calling code");
      var f = Ab(e, a, b, !0);
      d.a("****Parsing Result:****\n");
      d.a(JSON.stringify(new z(1).g(f)));
      d.a("\n\n****Validation Results:****");
      var g = Gb(f);
      var h = 0 == g || 4 == g;
      ...
      if (h)
        if (4 == m)
          ...
          t &&
            e &&
            (d.a("\nResult from isValidNumberForRegion(): "), d.a(Fb(U, f, b)));
          d.a("\nPhone Number region: ");
          d.a(Db(U, f));
      ...
      d.a("\n\n****Formatting Results:**** ");
      d.a("\nE164 format: ");
      d.a(t ? N(U, f, 0) : "invalid");
      d.a("\nOriginal format: ");
      d.a(xb(f, b));
      d.a("\nNational format: ");
      d.a(N(U, f, 2));
      d.a("\nInternational format: ");
      d.a(t ? N(U, f, 1) : "invalid");
      d.a("\nOut-of-country format from US: ");
      d.a(t ? vb(U, f, "US") : "invalid");
      d.a("\nOut-of-country format from Switzerland: ");
      d.a(t ? vb(U, f, "CH") : "invalid");
      0 < c.length &&
        (d.a("\nNational format with carrier code: "), d.a(pb(U, f, c)));
